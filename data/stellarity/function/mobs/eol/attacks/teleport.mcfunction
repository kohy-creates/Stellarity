...
execute as @n[type=area_effect_cloud,tag=stellarity.eol.teleport,sort=nearest] at @s rotated as @p rotated ~ 0 run tp ~ ~ ~

execute as @n[type=area_effect_cloud,tag=stellarity.eol.teleport,sort=nearest] at @s run function stellarity:mobs/eol/attacks/teleport_as_aec
