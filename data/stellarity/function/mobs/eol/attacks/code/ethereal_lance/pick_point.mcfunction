...
execute as @n[type=area_effect_cloud,tag=stellarity.eol.ethereal_lance.pick_point,sort=nearest] at @s run function stellarity:mobs/eol/attacks/code/ethereal_lance/as_aec
