...
execute if score @s stellarity.eol.hurt_time matches 10 as @n[type=armor_stand,sort=nearest,tag=stellarity.eol.as] at @s run function stellarity:mobs/eol/core/model/hurt
execute if score @s[tag=!stellarity.eol.hurt_10] stellarity.eol.hurt_time matches 9 as @n[type=armor_stand,sort=nearest,tag=stellarity.eol.as] at @s run function stellarity:mobs/eol/core/model/hurt
execute if score @s stellarity.eol.hurt_time matches 1 as @n[type=armor_stand,sort=nearest,tag=stellarity.eol.as] at @s run function stellarity:mobs/eol/core/model/daytime
