...
execute if score @s stellarity.misc matches 1 run scoreboard players operation @s stellarity.misc2 = @n[type=ender_dragon,sort=nearest] stellarity.dragon.health_percent
