summon shulker ~ ~ ~ {NoAI:1b,Invulnerable:1b,Color:10,Tags:["stellarity.dragon_shulker"],DeathLootTable:"",Attributes:[{Name:"generic.max_health",Base:20d},{Name:"generic.armor_toughness",Base:4d},{Name:"generic.follow_range",Base:40d}]}
