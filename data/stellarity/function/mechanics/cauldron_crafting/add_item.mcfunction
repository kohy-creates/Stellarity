...
data modify entity @e[type=item_display,limit=1,sort=nearest,tag=stellarity.brewing.display] item set from entity @e[type=item,distance=..0.5,limit=1,sort=nearest,nbt={Item:{count:1}}] Item
...
kill @e[type=item,distance=..0.5,tag=!stellarity.brewing.ignore,limit=1,sort=nearest,nbt={Item:{count:1}}]
