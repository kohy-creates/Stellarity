...
execute store result score #damage stellarity.misc run data get storage stellarity:temp elytra_nerf.player_data.Inventory[{Slot:102b}].components."minecraft:damage" 
...
function stellarity:mechanics/elytra_nerf/apply_damage_macro with storage stellarity:temp elytra_nerf
