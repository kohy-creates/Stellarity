...
kill @n[type=item,sort=nearest,nbt={Item:{id:"minecraft:crying_obsidian"}}]
execute positioned ~ ~1 ~ run kill @n[type=marker,sort=nearest,distance=..0.01,tag=stellarity.altar_of_the_light]
