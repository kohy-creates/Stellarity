...
data modify entity @n[type=minecraft:item_display,sort=nearest] transformation.scale set value [1.01f,1.01f,1.01f]

scoreboard players set @n[type=marker,sort=nearest,tag=stellarity.altar_of_the_light] stellarity.mechanics.altar_of_the_sacred.timer 230
