...
loot spawn ~ ~-.4 ~ loot stellarity:items/armor/shulker/boots
...
data modify entity @n[type=item,sort=nearest] Item.components."minecraft:trim" set from storage stellarity:temp aota.trim
...
advancement grant @p only stellarity:aota/craft_full_shulker_armor craft_shulker_boots
