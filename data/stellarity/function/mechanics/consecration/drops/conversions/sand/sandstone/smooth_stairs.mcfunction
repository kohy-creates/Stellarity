summon item ~ ~ ~ {Item:{id:"minecraft:smooth_red_sandstone_stairs",count:1b},Motion:[0d,0.033d,0d],Glowing:1b,NoGravity:1b,PickupDelay:10s,Tags:["stellarity.consecration.ignore"]}
