summon item ~ ~ ~ {Item:{id:"minecraft:stripped_cherry_log",count:1b},Motion:[0d,0.033d,0d],Glowing:1b,NoGravity:1b,PickupDelay:10s,Tags:["stellarity.consecration.ignore"]}
