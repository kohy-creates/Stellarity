...
summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["stellarity.voided"],potion_contents:{effects:[{id:"minecraft:wither",amplifier:0,duration:2,show_icon:0b}]},Duration:2,ReapplicationDelay:0,WaitTime:-1,Age:-1}
