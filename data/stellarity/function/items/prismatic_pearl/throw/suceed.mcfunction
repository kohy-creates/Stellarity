...
execute as @n[type=ender_pearl,sort=nearest] run tag @s add stellarity.prismatic_pearl
execute if entity @s[name="Bush_Lord",predicate=kohara:chance/50percent] as @n[type=ender_pearl,sort=nearest] run tag @s add stellarity.prismatic_pearl.bush
