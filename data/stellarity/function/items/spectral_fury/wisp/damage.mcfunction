...
execute if data entity @s {HurtTime:10s} as @n[type=marker,sort=nearest,tag=stellarity.wisp] at @s run function stellarity:items/spectral_fury/wisp/add_pierce
