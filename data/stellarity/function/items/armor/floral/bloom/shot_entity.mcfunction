...
execute if predicate stellarity:items/holding/sharanga run \
	data merge storage stellarity:temp {floral_armor:{bloom:{damage_base:20,damage_stack:10,duration_base:50,duration_stack:30}}}
execute if predicate stellarity:items/holding/call_of_the_void run \
	data merge storage stellarity:temp {floral_armor:{bloom:{damage_base:35,damage_stack:25,duration_base:70,duration_stack:30}}}
execute if predicate stellarity:items/holding/slayer_crossbow run \
	data merge storage stellarity:temp {floral_armor:{bloom:{damage_base:20,damage_stack:15,duration_base:60,duration_stack:30}}}
