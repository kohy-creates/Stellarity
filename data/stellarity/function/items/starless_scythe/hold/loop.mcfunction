...
execute anchored eyes run tp @n[type=interaction,sort=nearest,tag=stellarity.items.starless_scythe] ^ ^-0.25 ^3.25
execute as @n[type=interaction,sort=nearest,tag=stellarity.items.starless_scythe] if data entity @s attack run function stellarity:items/starless_scythe/hold/interaction_attacked
