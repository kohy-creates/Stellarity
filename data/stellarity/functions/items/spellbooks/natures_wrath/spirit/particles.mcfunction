...
execute if score @s stellarity.misc4 matches 1 rotated ~90 ~ run \
	particle minecraft:dust_color_transition{from_color: [1.0, 1.0, 1.0], scale: 1.0, to_color: [0.353, 0.525, 0.769]} ^ ^0.33 ^ 0 0 0 0 1 force @a[distance=..96]
...
execute if score @s stellarity.misc4 matches 1 rotated ~90 ~ run \
	particle minecraft:dust_color_transition{from_color: [1.0, 1.0, 1.0], scale: 1.0, to_color: [0.353, 0.525, 0.769]} ^ ^-0.1657 ^0.2854 0 0 0 0 1 force @a[distance=..96]
execute if score @s stellarity.misc4 matches 2 rotated ~90 ~30 run \
	particle minecraft:dust_color_transition{from_color: [1.0, 1.0, 1.0], scale: 1.0, to_color: [0.353, 0.525, 0.769]} ^ ^-0.1657 ^0.2854 0 0 0 0 1 force @a[distance=..96]
execute if score @s stellarity.misc4 matches 3 rotated ~90 ~60 run \
	particle minecraft:dust_color_transition{from_color: [1.0, 1.0, 1.0], scale: 1.0, to_color: [0.353, 0.525, 0.769]} ^ ^-0.1657 ^0.2854 0 0 0 0 1 force @a[distance=..96]
