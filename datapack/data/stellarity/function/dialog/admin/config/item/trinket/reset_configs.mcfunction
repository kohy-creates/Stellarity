scoreboard players set #stellarity.config stellarity.config.enable_crest_of_the_end 1
scoreboard players set #stellarity.config stellarity.config.enable_copper_elektra_shield 1
...
scoreboard players set #stellarity.config stellarity.config.enable_duskberry 1
scoreboard players set #stellarity.config stellarity.config.enable_satchel_of_voids 1
